                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 ml-auto mr-auto">
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="/make_registration" method="post">
                                        <div class="form-group">
                                            <label class="form-label" for="emailverify">Имя, Фамилия</label>
                                            <input type="username" id="usernameverify" class="form-control" name="username" placeholder="Ваше имя" required>
