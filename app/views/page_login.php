...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="./app/views/img/favicon/favicon-32x32.png">
    <link rel="mask-icon" href="./app/views/img/favicon/safari-pinned-tab.svg" color="#5bbad5">
    <link rel="stylesheet" media="screen, print" href="./app/views/css/page-login-alt.css">
</head>
<body>
    ...
    <div class="blankpage-form-field">
        <div class="page-logo m-0 w-100 align-items-center justify-content-center rounded border-bottom-left-radius-0 border-bottom-right-radius-0 px-4">
            <a href="javascript:void(0)" class="page-logo-link press-scale-down d-flex align-items-center">
                <img src="./app/views/img/logo.png" alt="SmartAdmin WebApp" aria-roledescription="logo">
    ...
    <video poster="./app/views/img/backgrounds/clouds.png" id="bgvid" playsinline autoplay muted loop>
        <source src="./app/views/media/video/cc.webm" type="video/webm">
        <source src="./app/views/media/video/cc.mp4" type="video/mp4">
    </video>
